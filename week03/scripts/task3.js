...
document.getElementById("odds").innerHTML = numbers.filter(i => i % 2 === 1);
// Step 4: Use the filter array method to find all of the even numbers of the array variable and assign the result to the HTML element with an ID of "evens"
document.getElementById("evens").innerHTML = numbers.filter(i => i % 2 === 0);
...
document.getElementById("sumOfMultiplied").innerHTML = numbers.map(i => i * 2).reduce((total, num) => total + num);